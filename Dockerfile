...
COPY EatonRootCA2.pem .
ADD EatonRootCA2.pem /usr/local/share/ca-certificates/EatonRootCA2.pem
ADD EatonRootCA2.pem /etc/ssl/certs/EatonRootCA2.pem
RUN chmod 644 /usr/local/share/ca-certificates/EatonRootCA2.pem  
